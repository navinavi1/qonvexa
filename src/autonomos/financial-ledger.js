export function ledgerEntry({id='',type,jobId='',externalId='',externalTransactionId='',source='',grossUsd=0,amountUsd=null,feeUsd=0,apiCostUsd=0,networkFeeUsd=0,currency='USD',rail='',network='',txId='',status='recorded',estimated=false,note='',allocation=null,testnet=false,productId='',displayAmountUsd=null}={}){
  ...
  return{
    id:id||'',at:new Date().toISOString(),type:kind,jobId,externalId,externalTransactionId,source,
