...
// The marketplace cut is taken out of the payout, so it is incurred only on the branch
// where the payout happens. Subtracting it at face value from a probability-weighted
// payout made the comparison independent of payout size (see profit-engine.js), which is
// why large, clearly profitable contracts scored as losses here too.
