...
// Remove a connector-contract regression that only exercised the retired Superteam HTTP
// feed. Generic competitive-registry reconciliation tests remain intact above it.
