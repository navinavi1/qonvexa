...
// Marketplace hardening should continue to verify the live-search parser, but against the
// free public search implementation instead of the retired Firecrawl API contract.
